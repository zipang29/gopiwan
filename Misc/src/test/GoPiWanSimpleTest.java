...
public class GoPiWanSimpleTest implements BrickPiUpdateListener{
	...
	public GoPiWanSimpleTest() throws SocketException{
		
		socket = new DatagramSocket(DEFAULT_PORT) ;
		this.init();
	}
	
	public GoPiWanSimpleTest(int port) throws SocketException{
	...
	public void init(){
        ...
        brickPi.setMotor(motorLeft, 0);	// brancher les moteurs sur les bons ports
